...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 python -m torch.distributed.launch --master_port 1234 --nproc_per_node=8 \
        tools/train.py ./configs/PSMNet/scene_flow.py --launcher pytorch --validate --gpus 7 --resume_from /home/user/data1/StereoMatching/exps/PSMNet/scene_flow/epoch_4.pth
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 python -m torch.distributed.launch --master_port 1234 --nproc_per_node=7 \
        ...
        --resume_from /data1/StereoMatching/exps/AcfNet/scene_flow_uniform_enc/epoch_2.pth
